...
public interface ICommunityService
{
    ...
    Task<ServiceResult<CommunityWithCategoriesResponse>> GetByIdWithCategoriesAsync(long id);
    ...
    Task<ServiceResult<bool>> UpdateCommunityAsync(CommunityUpdateRequest communityUpdateRequest, long id);
